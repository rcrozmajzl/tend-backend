...
User.create(username: "test_user", email: Faker::Internet.email, Faker::Date.birthday(min_age: 18, max_age: 65), location: Faker::Address.city, avatar: "https://loremflickr.com/#{rand(150..200)}/#{rand(150..200)}/all", password:111)
